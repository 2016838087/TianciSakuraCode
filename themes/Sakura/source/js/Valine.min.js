...
var qq_img=m.cdn+a(e.get("mail"))+m.params;//默认gravator头像接口
      if(e.get("mail").indexOf("@qq.com") >= 0){
         ...
         if(result!==null){
             ...
             qq_img = "https://gravatar.loli.net/avatar/d41d8cd98f00b204e9800998ecf8427e?s=40&d=monsterid"
         }
     }
