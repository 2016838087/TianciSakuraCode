    ...
    for (var i = 0; i < this.files.length; i++) {
      ...
      $.ajax({
        ...
        beforeSend: function (xhr) {
          ...
          $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="/sakurajs/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
          lazyload()
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == '/sakurajs/sakura.png' || bgurl == '/sakurajs/plaid.jpg' || bgurl == '/sakurajs/star.png' || bgurl == '/sakurajs/point.png' || bgurl == '/sakurajs/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', '/sakurajs/sakura.png')
  changeBG('#gribs-bg', '/sakurajs/plaid.jpg')
  changeBG('#pixiv-bg', '/sakurajs/star.png')
  changeBG('#KAdots-bg', '/sakurajs/point.png')
  changeBG('#totem-bg', '/sakurajs/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(/sakurajs/starry_sky.png)')
