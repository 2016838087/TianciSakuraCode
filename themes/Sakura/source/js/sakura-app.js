...
function imgError (ele, type) {
  switch (type) {
    ...
    default:
      // ele.src = 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/cdn/img/image-404.png'
      ele.src = 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/images/loading.gif'
  }
}
    ...
    for (var i = 0; i < this.files.length; i++) {
      ...
      $.ajax({
        ...
        beforeSend: function (xhr) {
          ...
          $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
          lazyload()
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/sakura.png' || bgurl == 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/plaid.jpg' || bgurl == 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/star.png' || bgurl == 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/point.png' || bgurl == 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/sakura.png')
  changeBG('#gribs-bg', 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/plaid.jpg')
  changeBG('#pixiv-bg', 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/star.png')
  changeBG('#KAdots-bg', 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/point.png')
  changeBG('#totem-bg', 'https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://fastly.jsdelivr.net/gh/2016838087/SakuraHexoFile@master/themes/sakurajs/starry_sky.png)')
